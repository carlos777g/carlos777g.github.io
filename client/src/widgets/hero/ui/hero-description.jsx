...
export const HeroDescription = () => {
  return (
    <div className="flex flex-col gap-0 mt-14 pr-10 pl-2 md:mt-0 md:px-0 text-right items-end">
      {/* Role / Accent Text */}
      <h2 className="text-accent font-bold text-md tracking-tighter z-10">
        Telematics Engineer in the
      </h2>
      <h2 className="text-accent font-bold text-md tracking-tighter z-10">making & Full-stack Developer, btw.</h2>
