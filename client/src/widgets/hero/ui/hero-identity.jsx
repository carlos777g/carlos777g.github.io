  ...
  return (
    <div className="flex items-center justify-around w-full relative md:translate-y-10 lg:translate-y-14">
      ...
      <div className="relative shrink-0 lg:-translate-y-10 lg:translate-x-5 xl:translate-x-4">
        {/* Floating Greeting */}
        <div className="absolute -top-20 -right-2 sm:-right-10 md:-top-24 md:-right-13 lg:-top-25 lg:-right-2 w-max rotate-12 z-30 pointer-events-none">
          <span className="text-accent font-black text-xl sm:text-3xl md:text-4xl lg:text-3xl animate-breathe inline-block drop-shadow-md">
            Hello world!
          </span>
        </div>

        {/* The Frame scales naturally across breakpoints */}
        <div className="-translate-y-8 relative w-40 sm:w-67 md:w-80 lg:w-60 xl:w-74 aspect-48/37 z-20">
