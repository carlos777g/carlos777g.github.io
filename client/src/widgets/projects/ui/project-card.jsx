...
export const ProjectCard = ({ project }) => {
  return (
    <article className="group flex flex-col rounded-md overflow-hidden">
      ...
      <div className="relative w-full aspect-video overflow-hidden">
        ...
        />
        {/* Optional overlay to darken image slightly until hovered */}
      </div>
            ...
            {project.stars > 0 && (
              <span className="flex items-end gap-1 text-sm font-mono cursor-default">
                ...
                <svg
                  ...
                  height="24"
                  viewBox="0 0 24 24"
                  // Animación inyectada directamente en el SVG
