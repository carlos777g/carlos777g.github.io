...
export const HeroDescription = () => {
  return (
    <div className="flex flex-col gap-2 w-full text-right sm:text-center lg:text-left">
      ...
      {/* Role / Accent Text */}
      <h3 className="text-accent font-bold text-xl sm:text-2xl lg:text-2xl tracking-tighter leading-tight">
        Telematics Engineer in the making & Full-stack Developer, btw.
      </h3>
      
      {/* Plain Text / Description */}
      <p className="text-glass-white/80 mt-2 text-sm sm:text-base lg:text-lg leading-relaxed ">
